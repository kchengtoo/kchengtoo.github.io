...
// designProjects.newProject("Meal Manager", "New setting feature that gives admins control over orders placed at specific stores using company funded meal credits", "meal-manager", "white", "rgba(87,0,0,", 1, 0);
...
designProjects.newProject("Platform Modularity Reports", "Report creation for clients with J.P. Morgan Access accounts within Chase Connect", "platform-modularity-reports", "white", "rgba(13,67,132,", 1, 1);
